const generateIssue = function(code, parameters) {
  ...
  switch (code) {
    case 'parentheses':
      ...
      break
    case 'attributeGroupBraces':
      issueObject.message = `ERROR: Number of opening and closing curly braces are unequal. ${parameters.opening} opening curly braces. ${parameters.closing} closing curly braces.`
      break
    case 'invalidTag':
